...
// import Vaccine from "./components/video/vaccine.mp4";
// import Home from './components/pages/Home';
import { Button, Col, Input, Row, Radio, Select, Checkbox, Tabs, Modal, Typography, notification, DatePicker, Breadcrumb, Layout, Menu, theme } from "antd";
...
class App extends React.Component {
  ...
  renderBookingPreferences() {
    ...
    return (
      <div className="vaccination" style={{marginLeft: 500}}>
      ...
      <div className="App" style={{
        ...
        {/* <header className="App-header">
          ...
          <p id="Intro">
            ...
            Proceed with booking on your behalf!! <br />
          </p>
          <p id="registration">
            Please register on{" "}
            <a
       ...
       <Row className="login-credentials">
          <Col>
            ...
            <Checkbox
              style={{ marginTop: 15, marginLeft: 500 }}
            ...
            <br />
            <Text type="secondary" style={{marginLeft: 500}}>
